...
/*감사님이 풀어주신 applicationContextEventListener*/
public class ApplicationContextEventListener {
	...
	public void handlerContextRefreshedEvent() {
		System.out.println("------- contextRefresh --------");
		SiteService siteSerivce = applicationContext.getBean(SiteService.class);
		SiteVo site = siteSerivce.getSite();
